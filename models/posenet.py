...
class SMPLModel(Module):
  ...
  def forward(self, net, input, trans, simplify=False):
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.smpl_f = SMPLModel(model_path=r"smpl\basicModel_f_lbs_10_207_0_v1.0.0.pkl")
        self.smpl_m = SMPLModel(model_path=r"smpl\basicmodel_m_lbs_10_207_0_v1.0.0.pkl")
